...
(function() {
  ...
  function MagicCharactersController() {
    ...
    vm.characters = [
      ...
      {name: '平賀才人',
	    ...
	    image: "assets/images/cards/characters/0211/saito.png",
	    maxHp: 4,
	    subtitle: "零之使魔",
	    from: "零之使魔",
	    skills: [
  ...
  illustrator: "緋華",
      ...
      {name: '佐仓杏子',
	    ...
	    image: "assets/images/cards/characters/0211/kyouko.png",
	    maxHp: 4,
	    subtitle: "红色幽灵",
	    from: "魔法少女小圆",
	    skills: [
      ...
      {name: '社长八云',
	    ...
	    image: "assets/images/cards/characters/0211/shachou.png",
	    maxHp: 4,
	    subtitle: "搬运社",
	    from: "拳皇/TH",
	    skills: [
      ...
      {name: '织田信奈',
	    ...
	    image: "assets/images/cards/characters/0211/nobuna.png",
	    maxHp: 3,
	    subtitle: "第六天魔王",
	    from: "织田信奈的野望",
	    skills: [
      ...
      {name: '魔王',
	    ...
	    image: "assets/images/cards/characters/0211/maou.png",
	    maxHp: 4,
	    subtitle: "红玉之瞳",
	    from: "魔王勇者",
	    skills: [
      ...
      {name: '葵·托利',
	    ...
	    image: "assets/images/cards/characters/0211/aoi.png",
	    maxHp: 4,
	    subtitle: "不可能之男",
	    from: "境界线上的地平线",
	    skills: [
      ...
      {name: '風鳴翼',
	    ...
	    image: "assets/images/cards/characters/0211/tsubasa.png",
	    maxHp: 4,
	    subtitle: "天羽羽斩",
	    from: "战姬绝唱",
	    skills: [
      ...
      {name: '小日向未来',
	    ...
	    image: "assets/images/cards/characters/0211/miki.png",
	    maxHp: 3,
	    subtitle: "神兽镜",
	    from: "战姬绝唱",
	    skills: [
      ...
      {name: '雪音クリス',
	    ...
	    image: "assets/images/cards/characters/0211/kurisu.png",
	    maxHp: 3,
	    subtitle: "魔弓",
	    from: "战姬绝唱",
	    skills: [
