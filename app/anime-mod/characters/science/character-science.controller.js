  ...
  function ScienceCharactersController() {
    ...
    vm.characters = [
      ...
      },
      {
        ...
        image: "assets/images/cards/characters/渡边早季.jpg",
        maxHp: 3,
        subtitle: "伦理委员",
        from: "来自新世界",
        skills: [
      ...
      },
      {
        ...
        image: "assets/images/cards/characters/间宫明里.jpg",
        maxHp: 3,
        subtitle: "亚里亚的追随者",
        from: "绯弹的亚里亚AA",
        skills: [
      ...
      },
      {
        ...
        image: "assets/images/cards/characters/無名.png",
        maxHp: 3,
        subtitle: "待定",
        from: "甲铁城的卡巴内瑞",
        skills: [
      ...
      {
        name: '岬明乃',
        relative: "https://zh.moegirl.org/zh/%E5%B2%AC%E6%98%8E%E4%B9%83",
        image: "assets/images/cards/characters/岬明乃.jpg",
        maxHp: 3,
        subtitle: "待定",
        from: "高校舰队",
        skills: [
      ...
      {   name: '朝田诗乃',   relative: "https://zh.moegirl.org/%E6%9C%9D%E7%94%B0%E8%AF%97%E4%B9%83",   image: "assets/images/cards/characters/朝田诗乃.jpg",   maxHp: 3,   subtitle: "深蓝の狙击手",   from: "刀剑神域",   skills: [     {       name: "狙击「PGM Ultima Ratio HecateII」",       text: "锁定技,当你与其他角色计算距离时，始终为1；出牌阶段，你使用的【杀】不能被攻击范围内没有你的角色的【闪】响应。",     },     {       name: "箭雨「提拉莉雅·无制限歼灭」",       text: "出牌阶段限一次，你可以指定X+1名角色（X为你已损失的体力），视为你对他们使用一张【杀】。",     },   ],   designer: "Sword Elucidator",   voice: "泽城美雪",   illustrator: "A-1", },
      {   name: '黒雪姫',   relative: "https://zh.moegirl.org/%E9%BB%91%E9%9B%AA%E5%A7%AC",   image: "assets/images/cards/characters/黑雪姬.jpg",   maxHp: 4,   subtitle: "黑之睡莲",   from: "加速世界",   skills: [     {       name: "迅羽",       text: "出牌阶段限一次，你可以将一张手牌交给你攻击范围内的一名其他角色，视为对其使用一张【杀】（此【杀】不计入出牌阶段使用限制），此【杀】结算后，若你没有“蓝”标记，你获得目标角色一张牌。",     },     {       name: "黑扬「黑扬之羽蝶」",       text: "觉醒技，回合开始前，若场上有已觉醒的其他角色或有当前体力值为1的其他角色，你须减1点体力上限并摸两张牌，获得“超频”。",     },  {name: "超频", text:"回合开始前，你可以选择一项：1.弃置1枚“绿”标记或“蓝”并获得1枚“红”标记；2.弃置1枚“红”标记或“蓝”标记并获得1枚“绿”标记；3.弃置1枚“红”标记或“绿”标记并获得1枚“蓝”标记。若你拥有“红”标记，你使用“迅羽”时攻击范围无限且可以不交给目标角色手牌，若该角色的攻击范围内没有你，其失去1点体力；若你拥有“蓝”标记，将“迅羽”的“将一张手牌交给你攻击范围内的一名其他角色”改为“弃置你攻击范围内一名其他角色的一张手牌”，“出牌阶段限一次”改为“出牌阶段限X次（X为场上存活角色数）”；若你拥有“绿”标记，你获得“克己”。", waked: true} ],   designer: "昂翼天使",   voice: "三澤紗千香",   illustrator: "未知", },
